...
<div class="container-fluid dashboard-main-container">
  ...
  <div class="revenue-graph-container-rev mt-5">
    <div class="revenue-graph-wrapper-rev">
    <div class="revenue-graph-title px-4">
      <h3>Revenue Graph</h3>
    ...
    <div class="revenue-graph-canvas">
      <canvas id="revenue-graph-canvas-id"></canvas>
    </div>
  </div>
  </div>
