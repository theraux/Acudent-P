...
<div id="admin-patient-detail-view-page-id"
        ...
        <div class="profile ">
            <div class="header-text d-flex flex-row align-items-center mb-2 ">
                <div class="back-btn-con me-1">
                    <button class="back-btn" data-target="../../PHP/admin-ui/admin-subfolder/admin-patient-management.php"><i class="fas fa-arrow-left"
