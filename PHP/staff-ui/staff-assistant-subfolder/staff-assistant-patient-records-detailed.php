...
<div id="staff-assistant-patient-detail-view-page-id"
        ...
        <div class="profile ">
            <div class="header-text d-flex flex-row align-items-center mb-2 ">
                <div class="back-btn-con me-1">
                    <button class="back-btn" data-target="../../PHP/staff-ui/staff-assistant-subfolder/staff-assistant-patient-records.php"><i class="fas fa-arrow-left"
