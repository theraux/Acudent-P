<div id="staff-assistant-patient-page-id" class="information-record-main-container">
            ...
            <div
                ...
                <div class="col-12 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6 col-profile-box ">
                    <div class="profile-box" tabindex="0"
                        data-target="../../PHP/staff-ui/staff-assistant-subfolder/staff-assistant-patient-records-detailed.php" data-id="12345">
                                ...
                                <td>
                                    <div class="appointment-td-wrapper d-flex flex-row align-items-center">
                                        ...
                                        <button type="button" class="ms-auto td-view-button "
                                            data-target="../../PHP/staff-ui/staff-assistant-subfolder/staff-assistant-patient-records-detailed.php">
                                            View Details
                                        </button>
                                    </div>
                                </td>
