function initStaffAssistantPatientRecords() {
    const page = document.querySelector('#staff-assistant-patient-page-id');
  if (!page) return;
...
document.addEventListener('DOMContentLoaded', initStaffAssistantPatientRecords);
