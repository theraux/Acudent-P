function initStaffFrontDeskAppointments() {
    ...
    function renderStaffFrontDeskCalendar() {
                    ...
                    box.addEventListener('click', () => {
                        ...
                        if (datePickingMode) {
                            ...
                            if (appointmentMode === 'add') {
                                openStaffFrontDeskAppointmentModal(selectedDate);
                            } else if (appointmentMode === 'edit') {
                                openStaffFrontDeskEditModal(selectedDate);
                            }
                            datePickingMode = false;  // Reset after use
                            appointmentMode = null;   // Reset mode
                        } else {
                            if (dayAppointments.length > 0) {
                                openStaffFrontDeskViewModal(new Date(year, month, day), dayAppointments);
                            } else {
    ...
    function StaffFrontDeskprevmonth() {
        currentDate.setMonth(currentDate.getMonth() - 1);
        renderStaffFrontDeskCalendar();
    }

    function StaffFrontDesknextmonth() {
        currentDate.setMonth(currentDate.getMonth() + 1);
        renderStaffFrontDeskCalendar();
    }

    window.StaffFrontDeskprevmonth = StaffFrontDeskprevmonth;
    window.StaffFrontDesknextmonth = StaffFrontDesknextmonth;
    ...
    function openStaffFrontDeskAppointmentModal(date) {
    ...
    function openStaffFrontDeskEditModal(date) {
     ...
     function openStaffFrontDeskViewModal(date, dayAppointments) {
...
document.addEventListener("DOMContentLoaded", initStaffFrontDeskAppointments)