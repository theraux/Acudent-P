function initStaffFrontDeskPatientRecordsDetailed() {
    const page = document.querySelector('#staff-frontdesk-patient-detail-view-page-id');
  if (!page) return;
    ...
    if (backBtn) {
        backBtn.addEventListener('click', () => {
            const url = backBtn.getAttribute('data-target') || '../../HTML/staff-ui/staff-frontdesk-subfolder/staff-frontdesk-patient-records-detailed.html';
...
document.addEventListener('DOMContentLoaded', initStaffFrontDeskPatientRecordsDetailed);
